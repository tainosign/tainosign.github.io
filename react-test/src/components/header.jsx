 ...
 * * @param {object} props 
 * @param {string | null} props.userId - 認証ユーザーID
 * @param {boolean} props.isLoading - 認証またはデータ読み込み中フラグ
 * @param {object} props.data - useHeaderDataから取得した表示データ
 * @param {string} props.appId - アプリケーションID
 */
export const Header = ({ userId, isLoading, data, appId }) => {
